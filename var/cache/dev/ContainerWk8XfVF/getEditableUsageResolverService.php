...
class getEditableUsageResolverService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['Pimcore\\Document\\Editable\\EditableUsageResolver'] = new \Pimcore\Document\Editable\EditableUsageResolver(($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container)), ($container->services['Pimcore\\Document\\Renderer\\DocumentRenderer'] ?? self::getDocumentRendererService($container)));
    }
}
