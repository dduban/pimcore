...
class __TwigTemplate_fe2368c5704c8dbb9798a5c3b3a4c7e4 extends Template
{
    private $source;
    private $macros = [];
    ...
    <form method=\"post\" action=\"";
        ...
        // line 16
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["pimcore_csrf"]) || array_key_exists("pimcore_csrf", $context) ? $context["pimcore_csrf"] : (function () { throw new RuntimeError('Variable "pimcore_csrf" does not exist.', 16, $this->source); })()), "getCsrfToken", [twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 16, $this->source); })()), "request", [], "any", false, false, true, 16), "session", [], "any", false, false, true, 16)], "method", false, false, true, 16), 16, $this->source), "html", null, true);
        echo "\">
    ...
    <form id=\"pimcore_logout_form\" method=\"post\" action=\"";
        ...
        <input type=\"hidden\" name=\"csrfToken\" value=\"";
        // line 22
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["pimcore_csrf"]) || array_key_exists("pimcore_csrf", $context) ? $context["pimcore_csrf"] : (function () { throw new RuntimeError('Variable "pimcore_csrf" does not exist.', 22, $this->source); })()), "getCsrfToken", [twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 22, $this->source); })()), "request", [], "any", false, false, true, 22), "session", [], "any", false, false, true, 22)], "method", false, false, true, 22), 22, $this->source), "html", null, true);
        echo "\">
...
{% endblock %}
", "@PimcoreAdmin/admin/login/two_factor_authentication.html.twig", "/usr/home/PJ/domains/pimcore.pj.usermd.net/vendor/pimcore/admin-ui-classic-bundle/templates/admin/login/two_factor_authentication.html.twig");
    }
