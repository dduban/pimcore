...
class __TwigTemplate_df8fef35b197651650ecff389de0a0b5 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((isset($context["tokens"]) || array_key_exists("tokens", $context) ? $context["tokens"] : (function () { throw new RuntimeError('Variable "tokens" does not exist.', 43, $this->source); })())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
                // line 57
                echo "                    ";
                $context["css_class"] = (((((twig_get_attribute($this->env, $this->source, $context["result"], "status_code", [], "any", true, true, true, 57)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "status_code", [], "any", false, false, true, 57), 57, $this->source), 0)) : (0)) > 399)) ? ("status-error") : ((((((twig_get_attribute($this->env, $this->source, $context["result"], "status_code", [], "any", true, true, true, 57)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "status_code", [], "any", false, false, true, 57), 57, $this->source), 0)) : (0)) > 299)) ? ("status-warning") : ("status-success"))));
                // line 58
                echo "
                    <tr>
                        <td class=\"text-center\">
                            <span class=\"label ";
                // line 61
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["css_class"]) || array_key_exists("css_class", $context) ? $context["css_class"] : (function () { throw new RuntimeError('Variable "css_class" does not exist.', 61, $this->source); })()), 61, $this->source), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, $context["result"], "status_code", [], "any", true, true, true, 61)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "status_code", [], "any", false, false, true, 61), 61, $this->source), "n/a")) : ("n/a")), "html", null, true);
                echo "</span>
                        </td>
                        <td>
                            <span class=\"nowrap\">";
                // line 64
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "ip", [], "any", false, false, true, 64), 64, $this->source), "html", null, true);
                echo " ";
                ...
                echo "</span>
                        ...
                        <td>
                            <span class=\"nowrap\">";
                // line 67
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "method", [], "any", false, false, true, 67), 67, $this->source), "html", null, true);
                echo " ";
                ...
                echo "</span>
                        ...
                        <td class=\"break-long-words\">
                            ";
                // line 70
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "url", [], "any", false, false, true, 70), 70, $this->source), "html", null, true);
                echo "
                            ";
                // line 71
                ...
                // line 74
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "time", [], "any", false, false, true, 74), 74, $this->source), "c"), "html", null, true);
                echo "\">
                                ";
                // line 75
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "time", [], "any", false, false, true, 75), 75, $this->source), "d-M-Y"), "html", null, true);
                echo "
                            </time>
                            <time class=\"newline\" data-convert-to-user-timezone data-render-as-time datetime=\"";
                // line 77
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "time", [], "any", false, false, true, 77), 77, $this->source), "c"), "html", null, true);
                echo "\">
                                ";
                // line 78
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "time", [], "any", false, false, true, 78), 78, $this->source), "H:i:s"), "html", null, true);
                echo "
                            </time>
                        </td>
                        <td class=\"nowrap\"><a href=\"";
                // line 81
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("_profiler", ["token" => twig_get_attribute($this->env, $this->source, $context["result"], "token", [], "any", false, false, true, 81)]), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["result"], "token", [], "any", false, false, true, 81), 81, $this->source), "html", null, true);
                echo "</a></td>
                    </tr>
                ";
            }
...
";
    ...
    {
        return array (  318 => 5,  316 => 4,  295 => 3,  284 => 91,  278 => 87,  273 => 84,  262 => 81,  256 => 78,  252 => 77,  247 => 75,  243 => 74,  237 => 71,  233 => 70,  225 => 67,  217 => 64,  209 => 61,  204 => 58,  201 => 57,  197 => 56,  183 => 44,  181 => 43,  175 => 41,  165 => 40,  147 => 38,  129 => 37,  116 => 32,  106 => 31,  75 => 10,  65 => 9,  42 => 1,);
    }
...
{% endblock %}
", "@WebProfiler/Profiler/results.html.twig", "/usr/home/PJ/domains/pimcore.pj.usermd.net/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/results.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("if" => 43, "for" => 56, "set" => 57, "macro" => 3);
        static $filters = array("escape" => 41, "length" => 41, "default" => 57, "date" => 74, "merge" => 5);
        static $functions = array("path" => 81, "source" => 5);
