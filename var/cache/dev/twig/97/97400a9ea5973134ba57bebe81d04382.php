...
class __TwigTemplate_09047b4a3614802bb38c4ef6f87a40a2 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
            ...
            // line 54
            echo "        ";
            echo twig_call_macro($macros["_self"], "macro_render_metrics", [twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 54, $this->source); })()), "totals", [], "any", false, false, true, 54), true], 54, $context, $this->getSourceContext());
            echo "
        ...
        <div class=\"sf-tabs\">
            ...
            // line 59
            echo "            ";
            $context["cache_pools_with_calls"] = twig_array_merge(twig_array_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 59, $this->source); })()), "calls", [], "any", false, false, true, 59), 59, $this->source), function ($__calls__) use ($context, $macros) { $context["calls"] = $__calls__; return (twig_length_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["calls"]) || array_key_exists("calls", $context) ? $context["calls"] : (function () { throw new RuntimeError('Variable "calls" does not exist.', 59, $this->source); })()), 59, $this->source)) > 0); }), []);
            // line 60
            echo "            ";
            ...
            foreach ($context['_seq'] as $context["name"] => $context["calls"]) {
                ...
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 62, $this->source); })()), "statistics", [], "any", false, false, true, 62), $context["name"], [], "array", false, false, true, 62), "calls", [], "any", false, false, true, 62), 62, $this->source), "html", null, true);
                echo "</span></h3>
                ...
                if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "adapters", [], "any", false, true, true, 67), $context["name"], [], "array", true, true, true, 67)) {
                    // line 68
                    echo "                                <code>";
                    echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 68, $this->source); })()), "adapters", [], "any", false, false, true, 68), $context["name"], [], "array", false, false, true, 68), 68, $this->source), "html", null, true);
                    echo "</code>
                            ";
                } else {
                    // line 70
                ...
                if ((twig_length_filter($this->env, $context["calls"]) == 0)) {
                    ...
                    echo "                            <h4>Metrics</h4>
                            ";
                    // line 79
                    echo twig_call_macro($macros["_self"], "macro_render_metrics", [twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 79, $this->source); })()), "statistics", [], "any", false, false, true, 79), $context["name"], [], "array", false, false, true, 79)], 79, $context, $this->getSourceContext());
                    echo "
                ...
                if (twig_get_attribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, true, 106)) {
                    ...
                    // line 108
                    echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_array_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 108, $this->source); })()), "calls", [], "any", false, false, true, 108), 108, $this->source), function ($__calls__) use ($context, $macros) { $context["calls"] = $__calls__; return (0 == twig_length_filter($this->env, $this->sandbox->ensureToStringAllowed($context["calls"], 108, $this->source))); })), "html", null, true);
                    echo "</span></h3>
                    ...
                    // line 118
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(twig_sort_filter($this->env, twig_get_array_keys_filter(twig_array_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 118, $this->source); })()), "calls", [], "any", false, false, true, 118), function ($__calls__) use ($context, $macros) { $context["calls"] = $__calls__; return (0 == twig_length_filter($this->env, $context["calls"])); }))));
    ...
    public function macro_render_metrics($__pool__ = null, $__is_total__ = false, ...$__varargs__)
    {
        ...
        <div class=\"metric\">
            <span class=\"value\">";
            // line 134
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["pool"]) || array_key_exists("pool", $context) ? $context["pool"] : (function () { throw new RuntimeError('Variable "pool" does not exist.', 134, $this->source); })()), "calls", [], "any", false, false, true, 134), 134, $this->source), "html", null, true);
            echo "</span>
            <span class=\"label\">";
            // line 135
        ...
        <div class=\"metric\">
            <span class=\"value\">";
            // line 138
            echo twig_escape_filter($this->env, twig_sprintf("%0.2f", (twig_get_attribute($this->env, $this->source, (isset($context["pool"]) || array_key_exists("pool", $context) ? $context["pool"] : (function () { throw new RuntimeError('Variable "pool" does not exist.', 138, $this->source); })()), "time", [], "any", false, false, true, 138) * 1000)), "html", null, true);
        ...
        <div class=\"metric-group\">
            <div class=\"metric\">
                <span class=\"value\">";
            // line 146
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["pool"]) || array_key_exists("pool", $context) ? $context["pool"] : (function () { throw new RuntimeError('Variable "pool" does not exist.', 146, $this->source); })()), "reads", [], "any", false, false, true, 146), 146, $this->source), "html", null, true);
            echo "</span>
                <span class=\"label\">";
            // line 147
            ...
            <div class=\"metric\">
                <span class=\"value\">";
            // line 150
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["pool"]) || array_key_exists("pool", $context) ? $context["pool"] : (function () { throw new RuntimeError('Variable "pool" does not exist.', 150, $this->source); })()), "writes", [], "any", false, false, true, 150), 150, $this->source), "html", null, true);
            echo "</span>
                <span class=\"label\">";
            // line 151
            ...
            <div class=\"metric\">
                <span class=\"value\">";
            // line 154
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["pool"]) || array_key_exists("pool", $context) ? $context["pool"] : (function () { throw new RuntimeError('Variable "pool" does not exist.', 154, $this->source); })()), "deletes", [], "any", false, false, true, 154), 154, $this->source), "html", null, true);
            echo "</span>
                <span class=\"label\">";
            // line 155
        ...
        <div class=\"metric-group\">
            <div class=\"metric\">
                <span class=\"value\">";
            // line 163
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["pool"]) || array_key_exists("pool", $context) ? $context["pool"] : (function () { throw new RuntimeError('Variable "pool" does not exist.', 163, $this->source); })()), "hits", [], "any", false, false, true, 163), 163, $this->source), "html", null, true);
            echo "</span>
                <span class=\"label\">";
            // line 164
            ...
            <div class=\"metric\">
                <span class=\"value\">";
            // line 167
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["pool"]) || array_key_exists("pool", $context) ? $context["pool"] : (function () { throw new RuntimeError('Variable "pool" does not exist.', 167, $this->source); })()), "misses", [], "any", false, false, true, 167), 167, $this->source), "html", null, true);
            echo "</span>
                <span class=\"label\">";
            // line 168
...
";
    ...
    {
        return array (  523 => 172,  516 => 168,  512 => 167,  506 => 164,  502 => 163,  491 => 155,  487 => 154,  481 => 151,  477 => 150,  471 => 147,  467 => 146,  457 => 139,  453 => 138,  447 => 135,  443 => 134,  439 => 132,  419 => 131,  407 => 127,  393 => 126,  386 => 121,  377 => 119,  373 => 118,  360 => 108,  357 => 107,  355 => 106,  350 => 103,  345 => 100,  328 => 97,  324 => 96,  320 => 95,  316 => 94,  313 => 93,  296 => 92,  280 => 79,  277 => 78,  271 => 75,  268 => 74,  266 => 73,  263 => 72,  259 => 70,  253 => 68,  251 => 67,  241 => 62,  236 => 61,  218 => 60,  215 => 59,  207 => 54,  201 => 50,  199 => 49,  195 => 47,  185 => 46,  170 => 40,  164 => 38,  154 => 37,  141 => 33,  138 => 32,  132 => 29,  118 => 25,  111 => 21,  104 => 17,  100 => 15,  97 => 14,  90 => 10,  84 => 7,  79 => 6,  76 => 5,  73 => 4,  63 => 3,  40 => 1,);
    }
...
{% endmacro %}
", "@WebProfiler/Collector/cache.html.twig", "/usr/home/PJ/domains/pimcore.pj.usermd.net/vendor/symfony/web-profiler-bundle/Resources/views/Collector/cache.html.twig");
    }
