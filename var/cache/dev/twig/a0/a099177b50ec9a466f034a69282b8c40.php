...
class __TwigTemplate_f281b78ab759f38dcdcede117a0bbf07 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_render_simple_table($__label1__ = null, $__label2__ = null, $__data__ = null, ...$__varargs__)
    {
        ...
        <tr>
            ...
            // line 515
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["label1"]) || array_key_exists("label1", $context) ? $context["label1"] : (function () { throw new RuntimeError('Variable "label1" does not exist.', 515, $this->source); })()), 515, $this->source), "html", null, true);
            echo "</th>
            <th scope=\"col\">";
            // line 516
            echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["label2"]) || array_key_exists("label2", $context) ? $context["label2"] : (function () { throw new RuntimeError('Variable "label2" does not exist.', 516, $this->source); })()), 516, $this->source), "html", null, true);
            echo "</th>
        </tr>
        </thead>
        <tbody>
        ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["value"]) {
                ...
                <th scope=\"row\">";
                // line 522
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed($context["key"], 522, $this->source), "html", null, true);
                echo "</th>
                <td>";
                // line 523
                echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed($context["value"], 523, $this->source), "html", null, true);
                echo "</td>
            </tr>
        ";
            }
...
{% endmacro %}
", "@Doctrine/Collector/db.html.twig", "/usr/home/PJ/domains/pimcore.pj.usermd.net/vendor/doctrine/doctrine-bundle/Resources/views/Collector/db.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("import" => 3, "if" => 6, "set" => 8, "for" => 183, "macro" => 511);
