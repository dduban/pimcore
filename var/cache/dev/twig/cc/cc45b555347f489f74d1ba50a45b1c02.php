...
class __TwigTemplate_b85e93047b93ac5b4ebd05bde27d1f99 extends Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body class=\"pimcore_version_11 ";
        ...
        // line 19
        echo "        ";
        $context["customImage"] = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["adminSettings"]) || array_key_exists("adminSettings", $context) ? $context["adminSettings"] : (function () { throw new RuntimeError('Variable "adminSettings" does not exist.', 19, $this->source); })()), "branding", [], "array", false, false, true, 19), "login_screen_custom_image", [], "array", false, false, true, 19);
        // line 20
        echo "        ";
        // line 21
        echo "        ";
        ...
        if (twig_matches("@^https?://@", (isset($context["customImage"]) || array_key_exists("customImage", $context) ? $context["customImage"] : (function () { throw new RuntimeError('Variable "customImage" does not exist.', 22, $this->source); })()))) {
            ...
            // line 31
            echo "            ";
            $context["backgroundImageUrl"] = "/bundles/pimcoreadmin/img/login/pc11.svg";
            // line 32
            echo "        ";
        }
        // line 33
        ...
        ";
        // line 40
        $context["customColor"] = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["adminSettings"]) || array_key_exists("adminSettings", $context) ? $context["adminSettings"] : (function () { throw new RuntimeError('Variable "adminSettings" does not exist.', 40, $this->source); })()), "branding", [], "array", false, false, true, 40), "color_login_screen", [], "array", false, false, true, 40);
        // line 41
        echo "        ";
        ...
        echo "\" src=\"";
        echo twig_escape_filter($this->env, ($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("pimcore_settings_display_custom_logo") . ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["adminSettings"]) || array_key_exists("adminSettings", $context) ? $context["adminSettings"] : (function () { throw new RuntimeError('Variable "adminSettings" does not exist.', 54, $this->source); })()), "branding", [], "array", false, false, true, 54), "login_screen_invert_colors", [], "array", false, false, true, 54)) ? ("") : ("?white=true"))), "html", null, true);
        echo "\">
        </div>
...
";
    ...
    {
        return array (  208 => 93,  202 => 91,  200 => 90,  192 => 85,  186 => 81,  183 => 67,  178 => 65,  173 => 62,  171 => 61,  165 => 58,  156 => 54,  152 => 52,  145 => 48,  138 => 44,  134 => 42,  131 => 41,  129 => 40,  122 => 36,  117 => 33,  114 => 32,  111 => 31,  108 => 28,  105 => 27,  102 => 26,  99 => 25,  96 => 24,  93 => 23,  90 => 22,  88 => 21,  86 => 20,  83 => 19,  81 => 18,  77 => 17,  74 => 16,  63 => 14,  59 => 13,  45 => 1,);
    }
...
", "@PimcoreAdmin/admin/login/layout.html.twig", "/usr/home/PJ/domains/pimcore.pj.usermd.net/vendor/pimcore/admin-ui-classic-bundle/templates/admin/login/layout.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("for" => 13, "set" => 18, "if" => 22);
        static $filters = array("escape" => 14, "date" => 14, "trans" => 54, "raw" => 65);
