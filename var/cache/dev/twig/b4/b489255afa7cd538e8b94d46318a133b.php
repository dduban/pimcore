...
class __TwigTemplate_69bfac405faaceb15366cb9a5ca69dbe extends Template
{
    private $source;
    private $macros = [];
    ...
    <tr>
        ...
        echo "</td>
                        ...
                        <tr>
                            ...
                            <td>";
        // line 58
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, (isset($context["asset"]) || array_key_exists("asset", $context) ? $context["asset"] : (function () { throw new RuntimeError('Variable "asset" does not exist.', 58, $this->source); })()), "getFileSize", [true], "method", false, false, true, 58), 58, $this->source), "html", null, true);
        echo " </td>
                        </tr>
                        <tr>
                            <td>Mime Type</td>
...
", "@PimcoreAdmin/admin/asset/show_version_image.html.twig", "/usr/home/PJ/domains/pimcore.pj.usermd.net/vendor/pimcore/admin-ui-classic-bundle/templates/admin/asset/show_version_image.html.twig");
    }
